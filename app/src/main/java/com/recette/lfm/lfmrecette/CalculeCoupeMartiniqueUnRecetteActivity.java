...
public class CalculeCoupeMartiniqueUnRecetteActivity extends ActionBarActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_calcule_coupe_martinique_un_recette);
        ...
        //club visiteur 20%
        Double NrepartitionClubVisisteur=(NsoldeRepartir*20)/100;
